...
const initialBlogs = [
  ...
  },
  {
    ...
    excerpt:
      "SSL certificates are essential for website security and user trust. Learn what they are and why every website should have one.",
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <p className="text-lg text-center text-gray-600 mb-10 max-w-2xl mx-auto">
          Insights, news, and guides about web hosting, domain registration, and
          online security.
        </p>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <span className="bg-blue-50 text-kahf-blue text-xs font-medium px-2.5 py-1 rounded">
                    {blog.category}
                  </span>
                  <span className="text-xs text-gray-500">{blog.date}</span>
                </div>
                <Link to={`/blog/${blog.id}`} className="block">
                  <h2 className="text-xl font-semibold mb-2 hover:text-kahf-blue transition-colors">
                    {blog.title}
                  </h2>
                </Link>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Link
                    to={`/blog/${blog.id}`}
                    className="text-kahf-blue font-medium text-sm hover:underline"
                  >
                    Read more →
                  </Link>
                </div>
