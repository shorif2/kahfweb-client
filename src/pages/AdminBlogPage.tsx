...
const initialBlogs = [
  {
    ...
    content: '<p>This is a detailed guide about hosting plans.</p><h2>Shared Hosting</h2><p>Good for small websites.</p><h2>VPS Hosting</h2><p>Better for growing websites.</p>',
  ...
  },
  {
    ...
    content: '<p>Protect your website with these tips:</p><ul><li>Use strong passwords</li><li>Keep software updated</li><li>Install security plugins</li></ul>',
  ...
  },
  {
    ...
    content: '<p>Choosing the right domain registrar is important.</p><p>Here are the benefits of trusted providers:</p><ul><li>Better security</li><li>Reliable service</li></ul>',
    ...
    <>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          ...
          <p className="py-4">
            Are you sure you want to delete the blog post "{currentBlog?.title}"? This action cannot be undone.
          </p>
          <DialogFooter>
