  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="prose prose-blue max-w-none">
        ...
        <p>
          Welcome to KahfWeb ("Company", "we", "our", "us"). These Terms of Service ("Terms", "Terms of Service") govern your use of our website located at KahfWeb.com and any related services provided by KahfWeb.
        </p>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">4. Hosting and Domain Services</h2>
        <p>
          KahfWeb provides website hosting and domain registration services. We reserve the right to terminate services at our discretion for violations of our terms, including but not limited to hosting illegal content, spam, or malware.
        </p>
        <p>
          Domain registrations are subject to the policies of the respective registry and ICANN rules. We act as a reseller of domain name registrations and make no representations about the availability of domain names until confirmed.
        </p>
        ...
        <p>
          In no event shall KahfWeb, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.
        </p>
        ...
        <p>
          If you have any questions about these Terms, please contact us at support@kahfweb.com
        </p>
      </div>
    </div>
  );
