  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="prose prose-blue max-w-none">
        ...
        <p>
          KahfWeb ("us", "we", or "our") operates the KahfWeb.com website (the "Service").
        ...
        <h4 className="text-lg font-semibold mt-4 mb-2">Tracking & Cookies Data</h4>
        <p>
        ...
        <p>
          KahfWeb uses the collected data for various purposes:
        </p>
        <ul className="list-disc pl-6 mb-4">
        ...
        <p>
          KahfWeb may disclose your Personal Data in the good faith belief that such action is necessary to:
        </p>
        <ul className="list-disc pl-6 mb-4">
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of KahfWeb</li>
        ...
        <p>
          KahfWeb aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.
        </p>
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>By email: privacy@kahfweb.com</li>
        </ul>
      </div>
    </div>
  );
