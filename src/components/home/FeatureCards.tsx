const features = [
  {
    ...
    description:
      "Moving to KahfWeb is easy, we'll take care of the migration for you for FREE",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-10 w-10 text-kahf-blue"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
  ...
  },
  {
    title: "24/7 support",
    description:
      "Our team is always online 24/7 for your support and customer service.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-10 w-10 text-kahf-blue"
